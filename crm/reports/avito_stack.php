...
?>
  ...
  <p>Автоматический отбор проводится 2 раза в сутки (<b>7:25 и 15:25</b>) по следующим критериям: активные заявки на продажу с не пустой ценой и описанием, с привязанным объектом, с фото или планировками, не относящиеся к категории "земельные участки" или
    "коммерческая недвижимость". Сотрировка этой очереди проходит по убыванию даты изменения, т.е. новые и недавно отредактированные заявки находятся в начале очереди</p>
  <p>
    На текущий момент отбор производится по 5 первых за раз, таким образом в день отбирается 10 новых заявок на выгрузку.
  </p>
  <p>
