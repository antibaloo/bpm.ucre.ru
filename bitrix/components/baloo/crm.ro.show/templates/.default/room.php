	...
	array(
	  ...
	  "TABS"=>array(
        ...
        array("id"=>"PROPERTY_321", "name"=>"Цена", "type"=>"label","value" => number_format($arResult['DATA']['PROPERTY_321'], 2, '.', ' ').' руб.'),
			...
			array("id"=>"tab4", "name"=>"Информация о комнате", "icon"=>"", "fields"=>array(
				array("id" => "PROPERTY_228", "name" => "Площаль комнаты", "type" => "label", "value" => number_format($arResult['DATA']['PROPERTY_228'], 2, ',', '').' кв.м.'),
				array("id" => "PROPERTY_229", "name" => "Количество комнат в квартире", "type" => "label", "value"=>intval ($arResult['DATA']['PROPERTY_229'])),
	...
	array(
	  ...
	  "TABS"=>array(
        ...
        array("id"=>"PROPERTY_321", "name"=>"Цена", "type"=>"label","value" => number_format($arResult['DATA']['PROPERTY_321'], 2, '.', ' ').' руб.'),
			...
			array("id"=>"tab4", "name"=>"Информация о комнате", "icon"=>"", "fields"=>array(
				array("id" => "PROPERTY_228", "name" => "Площадь комнаты", "type" => "label", "value" => number_format($arResult['DATA']['PROPERTY_228'], 2, ',', '').' кв.м.'),
				array("id" => "PROPERTY_229", "name" => "Количество комнат в квартире", "type" => "label", "value"=>intval ($arResult['DATA']['PROPERTY_229'])),
				array("id" => "PROPERTY_224", "name" => "Общая площадь", "type" => "label", "value" => number_format($arResult['DATA']['PROPERTY_224'], 2, ',', '').' кв.м.'),
				array("id" => "PROPERTY_225", "name" => "Жилая площадь", "type" => "label", "value" => number_format($arResult['DATA']['PROPERTY_225'], 2, ',', '').' кв.м.'),
				array("id" => "PROPERTY_226", "name" => "Площадь кухни", "type" => "label", "value" => number_format($arResult['DATA']['PROPERTY_226'], 2, ',', '').' кв.м.'),
      ...
      array("id"=>"tab8", "name"=>"Информация о договоре", "icon"=>"", "fields"=>array(
			...
			array("id"=>"tab9", "name"=>"Служебная информация", "icon"=>"", "fields"=>array(
				array("id"=>"ID", "name"=>"ID", "type"=>"label"),
        array("id"=>"CODE", "name"=>"Код объекта ecrplus.ru", "type"=>"label") ,
				array("id"=>"ASSINGNED_BY", "name"=>"Ответственный", "type" => "label","value" =>$arResult['USERS'][intval($arResult['DATA']['PROPERTY_313'])]),
				array("id"=>"DATE_CREATE", "name"=>"Дата создания", "type" => "label"),
				array("id"=>"MODIFIED_BY", "name"=>"Изменил", "type" => "label","value" =>$arResult['USERS'][intval($arResult['DATA']['MODIFIED_BY'])]),
				array("id"=>"TIMESTAMP_X", "name"=>"Дата изменения", "type" => "label"),
				array("id"=>"PROPERTY_260", "name"=>"Срок выгрузки на Авито", "type" => "label"),
