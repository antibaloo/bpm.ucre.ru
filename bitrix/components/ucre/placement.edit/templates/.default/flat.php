...
$APPLICATION->SetTitle("Заполните параметры квартиры");
...
<form id ="placementForm" method="POST" action="<?=$_SERVER["REQUEST_URI"]?>">
  <div class="typeWrapper">
    <div class="empty"></div>
    <div class="placementType">Нежилое помещение</div>
    <div class="placementType">Комната</div>
    <div class="placementType chosen">Квартира</div>
    <div class="empty"></div>
  </div>
 <div class="paramsWrapper">
    ...
    <div class="label paramBox <?=($arResult['errors']['UF_PL_NUMBER'])?"fieldError":""?>" title="<?=($arResult['errors']['UF_PL_NUMBER'])?$arResult['errors']['UF_PL_NUMBER']:""?>">Номер квартиры *</div>
