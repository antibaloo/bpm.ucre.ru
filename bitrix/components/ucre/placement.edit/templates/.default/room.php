...
$APPLICATION->SetTitle("Заполните параметры комнаты");
...
<form id ="placementForm" method="POST" action="<?=$_SERVER["REQUEST_URI"]?>">
  <div class="typeWrapper">
    ...
    <div class="placementType chosen">Комната</div>
  ...
  <div class="paramsWrapper">
    ...
    <div class="label paramBox <?=($arResult['errors']['UF_PL_NUMBER'])?"fieldError":""?>" title="<?=($arResult['errors']['UF_PL_NUMBER'])?$arResult['errors']['UF_PL_NUMBER']:""?>">Номер комнаты *</div>
